        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
              Nossa operação logística atende todas as rotas do Brasil,
              conectando centros produtores aos maiores polos consumidores do
              país com eficiência e pontualidade. Com rotas otimizadas e pontos
              de apoio estratégicos, garantimos entregas rápidas e seguras em
          ...
          <div className="bg-secondary rounded-2xl p-8 md:p-12 text-secondary-foreground text-center">
            <h3 className="text-2xl font-bold mb-4">
              Precisa de uma rota específica?
            </h3>
